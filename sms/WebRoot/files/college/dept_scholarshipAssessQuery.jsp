														...
														<li>
															...
															<ul>
																...
																<li>
																	...
																	<ul>
																		<li>
																			<a href="#" onclick="manually('entryScholarshipAssessInfo')">手动录入</a>
																		</li>
																		<li>
																			<a href="#">导入</a>
																		</li>																		
															...
															<tr>
																<td height="40" class="font42">
																	...
																	<table border="0" cellpadding="4"
																		cellspacing="1" bgcolor="#464646" class="demo" id = "entryScholarshipAssessInfo">
																		<tr class="CTitle" align = "center">
																			<td height="22" colspan="22" align="center"
																				style="font-size: 16px">
																				学生奖学金信息录入表
																			</td>
																		</tr>
                                                                 <tr bgcolor="#EEEEEE" align = "center">
                                                                  <td width="10%" rowspan="3"> 学号 </td>
                                                                  <td width="10%" rowspan="3"> 姓名 </td>
                                                                  <td colspan="4" width="20%"> 德育素质测评（20%）</td>
                                                                  <td colspan="5" width="20%"> 智育素质测评（60%）</td>
                                                                  <td colspan="4" width="20%">体育素质测评（5%）</td>
                                                                  <td colspan="4" width="20%">美育素质测评（15%）</td>
                                                                  <td colspan="2" rowspan="2" width="5%">综合测评</td>
                                                                  <td width="5%" rowspan="3"> 奖学金等级</td>
                                                                </tr>
                                                                <tr bgcolor="#EEEEEE" align = "center">
                                                                ...
                                                                <tr bgcolor="#EEEEEE" align = "center">
                                                                  <td width="3%">必修课成绩</td>
                                                                  <td width="3%">公选课惩罚分</td>
                                                                  <td width="2%">总得分</td>
                                                                  <td width="3%">排名</td>
                                                                </tr>
																<tr bgcolor="#EEEEEE" align = "center" >
																			<td colspan="22" style="padding:1px">
