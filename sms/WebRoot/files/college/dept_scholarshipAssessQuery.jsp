																...
																<td height="33">
																	<table width="100%" border="0" align="center"
																		...
																		<form action="<%=basePath%>scholarShip/scholarShip!querySchloarShipForTeacher" method="post">
																				...
																				<input type="hidden"	 name="sex" value="<s:property value="#request.params['sex']"/>">
																				 	<input type="hidden"	 name="advLevel" value="<s:property value="#request.params['rank']"/>">
																				 	<input type="hidden"	 name="advRank" value="<s:property value="#request.params['totalScoreRank']"/>">
																				 	<input type="hidden"	 name="advScore" value="<s:property value="#request.params['totalScore']"/>">
																			 	[
