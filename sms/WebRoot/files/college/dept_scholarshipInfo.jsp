...
<title>My JSP 'dept_scholarshipInfo.jsp' starting page</title>
												...
												<ul id="suckertree1">
													<li><a href="#">信息管理</a>
														<ul>
															...
															<li><a
																href="dept_scholarshipInfo/dept_scholarshipInfo_proportion.html">分配比例</a>
															</li>
														</ul></li>
												</ul>
											</div></td>
								...
								<td class="CPanel">
									<div id="liulanbiao" style="margin-left: 10px">
										<table width="99%" border="0" cellpadding="0" cellspacing="0"
											class="CContent">
											<tr>
												<th class="tablestyle_title">当前位置：奖助学信息页面<span
													style="position:relative;left:950px"><a
														href="dept_scholarshipInfo/dept_scholarshipInfo_verify.html"><font
														...
														<tr>
															<td height="40" class="font42">
																<table width="100%" border="0" cellpadding="4"
																	...
																	<thead>
																		<tr class="CTitle">
																			<td height="22" colspan="16" align="center"
																		...
																		<tr bgcolor="#EEEEEE" align="center">
																			...
																			<th rowspan="2"><span class="STYLE3">
																					<center>学号</center> </span>
																			</td>
																			<th rowspan="2"><span class="STYLE3">
																					<center>姓名</center> </span>
																			</td>
																			<th rowspan="2"><span class="STYLE3">
																					<center>学院</center> </span>
																			</td>
																			<th rowspan="2"><span class="STYLE3">
																					<center>专业</center> </span>
																			</td>
																			<th rowspan="2"><span class="STYLE3">
																					<center>班级</center> </span>
																			</th>
																			<th colspan="2"><span class="STYLE3">
																					<center>上半年获奖学金情况</center>
																			</span>
																			</th>
																			<th rowspan="2"><span class="STYLE3"><center>上学年奖助信息</center>
																			</span>
																			</th>
																			<th rowspan="2"><span class="STYLE3"><center>上学年贫困等级</center>
																			</span>
																			</th>
																			<th rowspan="2"><span class="STYLE3">
																					<center>本学年贫困等级</center>
																			</span>
																			</th>
																			<th rowspan="2"><span class="STYLE3">
																					<center>奖助学名称</center> </span>
																			</th>
																			<th rowspan="2"><span class="STYLE3">
																					<center>性质</center> </span>
																			</th>
																			<th rowspan="2"><span class="STYLE3">
																					<center>获奖时间</center> </span>
																			</th>
																			<th rowspan="2"><span class="STYLE3">
																					<center>金额</center> </span>
																			</th>
																			<th rowspan="2"><span class="STYLE3">
																					<center>审核状态</center> </span>
																			</th>
																		</tr>
																		<tr bgcolor="#EEEEEE">
																			<th><span class="STYLE3">上半学年</span>
																			</th>
																			<th><span class="STYLE3">下半学年</span>
																			</th>
																		</tr>
																	</thead>
		...
		<div class="form">
			<table width="50%" border="0" cellpadding="4" cellspacing="1"
				...
				<thead>
					...
					<tr bgcolor="#FFFFFF" align="center">
						<td width='15%' name='projectName'>性别</td>
						<td width='35%'><input name="sex" type="radio" value="sex"
							checked />男 <input name="sex" type="radio" value="sex" />女</td>
					</tr>
					<tr bgcolor="#FFFFFF" align="center">
						<td width='15%' name='projectName'>奖助学名称</td>
						<td width='35%'><select name="awaName">
								<option>国家奖学金</option>
								<option>国家励志</option>
								<option>国家助学金</option>
								<option>校奖学金</option>
					...
					<tr bgcolor="#FFFFFF" align="center">
						<td width='15%'>奖助学性质</td>
						<td width='35%'><select name="awaProperty">
								<option>国家</option>
								<option>学校</option>
								<option>企业资助</option>
								<option>个人资助</option>
					...
					<tr bgcolor="#FFFFFF" align="center">
						<!--使用juquery的时间插件-->
						<td width='15%' name='projectName'>获奖时间</td>
						<td width='35%'><select name="awardTime">
					...
					<tr bgcolor="#FFFFFF" align="center">
						<!--使用juquery的时间插件-->
						<td width='15%' name='projectName'>获奖金额</td>
						<td width='35%'><input type="text" size="10" name="fare"
							id="fare" /></td>
					</tr>
					<tr bgcolor="#FFFFFF" align="center">
						<!--使用juquery的时间插件-->
						<td width='15%' name='projectName'>本学年贫困等级</td>
						<td width='35%'><select name="prePovertyLevel">
								<option>甲等</option>
								<option>乙等</option>
								<option>丙等</option>
						</select></td>
					...
					<tr bgcolor="#FFFFFF" align="center">
						<!--使用juquery的时间插件-->
						<td width='15%' name='projectName'>上学年贫困等级</td>
						<td width='35%'><select name="PastPovertyLevel">
								<option>甲等</option>
								<option>乙等</option>
								<option>丙等</option>
						</select></td>
