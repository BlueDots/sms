...
<html>
  <head>
    ...
    <title>My JSP 'admin_userPurview.jsp' starting page</title>
												...
												<div class="suckerdiv">
													<ul id="suckertree1">
														<li>
															...
															<ul>
															 	<li>
																	<a href="./admin_addPower.html">编辑</a>
																</li>															
															</ul>
														</li>
													</ul>
											...
											<table width="99%" border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													<th class="tablestyle_title">
														当前位置： <a href="#" style="color:red;">分配权限管理</a>&gt;&gt;<a style="color:red;" href="#">用户分配权限</a> 
													</th>
												</tr>
												<tr>
													<td class="CPanel">
																	...
																	<table width="100%" border="0" cellpadding="4"
																		...
																		<tr bgcolor="#FFFFFF" align="center">
																		  <td><input type="checkbox" name="delid" /></td>
																			...
																			<td>团委书记</td>
																			<td>软件学院</td>
																			<td><a href="admin_rolePurview.html">已分配</a></td>
																		</tr>
																		...
																		<tr bgcolor="#FFFFFF" align="center">
																		  <td><input type="checkbox" name="delid" /></td>
																			...
																			<td>党委书记</td>
																			<td>学工处</td>
																			<td><a href="admin_rolePurview.html"><font color="red">未分配</font></a></td>
																		</tr>
