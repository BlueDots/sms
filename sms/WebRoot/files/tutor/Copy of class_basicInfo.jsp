																...
																<td height="40" class="font42">
																	<table width="100%" border="0" cellpadding="4"
																		...
																		<tr bgcolor="#FFFFFF">
																			...
																			<td>
																				<a href="#" onclick="popup('#SchStuBasicInfoDiv', '#getSchStuBasicInfoDiv', '#CloseBasicInfo')">20111826</a>
																			</td>
																			<td>
																				旮旯子
																			</td>
            	...
            	<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="demo" id="tableID" ><thead>
            		<tr class="CTitle">
            			<td height="22" colspan="12" align="center" style="font-size: 16px">
            				学生基本信息表
            				&nbsp
            				<input type="button" name="modify" onclick="" value="修改"/>
						</td>
					</tr>
					<tr bgcolor="#FFFFFF">
						<td width="6%">学号</td>
